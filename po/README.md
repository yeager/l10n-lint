...
Translations for **l10n-lint** are managed via **Transifex**:

👉 https://www.transifex.com/danielnylander/l10n-lint/

## How to contribute translations

1. Create a free account on [Transifex](https://www.transifex.com/)
2. Join the [l10n-lint project](https://www.transifex.com/danielnylander/l10n-lint/)
