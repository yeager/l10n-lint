...
[![Version](https://img.shields.io/badge/version-1.21.4-blue)](https://github.com/yeager/l10n-lint/releases/tag/v1.21.4)
...
[Download 1.21.4](https://github.com/yeager/l10n-lint/releases/tag/v1.21.4)
· [Changelog](CHANGELOG.md) · [Report a bug](https://github.com/yeager/l10n-lint/issues)

Version **1.21.4** fixes CI coverage and Swedish compound spelling while preserving
...
Download the package for your system from [release 1.21.4](https://github.com/yeager/l10n-lint/releases/tag/v1.21.4).
The release includes `.deb`, `.rpm`, a Python wheel, a source archive and `SHA256SUMS`.

| System | Download | Install command |
|--------|----------|-----------------|
| Debian / Ubuntu | [Debian package](https://github.com/yeager/l10n-lint/releases/download/v1.21.4/l10n-lint_1.21.4-1_all.deb) | `sudo apt install ./l10n-lint_1.21.4-1_all.deb` |
| Fedora | [RPM package](https://github.com/yeager/l10n-lint/releases/download/v1.21.4/l10n-lint-1.21.4-1.noarch.rpm) | `sudo dnf install ./l10n-lint-1.21.4-1.noarch.rpm` |

For the Python CLI, download the [wheel](https://github.com/yeager/l10n-lint/releases/download/v1.21.4/l10n_lint-1.21.4-py3-none-any.whl)
and use Python 3.9 or newer in a virtual environment:

```sh
python3 -m venv .venv
. .venv/bin/activate
python -m pip install ./l10n_lint-1.21.4-py3-none-any.whl
l10n-lint --version
```
...
- **1.21.4**: Fix CI coverage and Swedish compound spelling regressions
